...
def get_args_parser():
    ...
    parser.add_argument(
        ...
        type=int,
        required=False,
        help="Number of gpus for distributed training, not implemented in official dino repo",
    )
    parser.add_argument(
        "--arch",
        default="vit_small",
    ...
    parser.add_argument(
        "--resume_dir", default=".", type=str, help="Path to resume checkpoints."
    )
    parser.add_argument(
...
def train_dino(args):
    ...
    teacher = utils.MultiCropWrapper(
        teacher, DINOHead(embed_dim, args.out_dim, args.use_bn_in_head), arch=args.arch
    )
